...
$string['visibility'] = 'Sichtbarkeit der Mitglieder - Voreinstellung';
$string['visibility_help'] = 'Geben Sie hier den Standard vor, wie neue Slots angelegt werden sollen: 1. "Anonym": Die Namen anderer Teilnehmer/innen eines Slots sind einem/r Teilnehmer/-in stets verborgen. 2. "Sichtbar nur, wenn eigener Slot": Die Namen der anderen Teilnehmer/-innen eines Slots sind nur sichtbar, wenn man den Slot selber gebucht hat. 3. "Sichtbar": Die Teilnehmer/innen dieses Slots werden immer angezeigt.';
