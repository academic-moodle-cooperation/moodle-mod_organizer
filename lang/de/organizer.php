...
$string['message_custommessage_help'] = 'Geben sie hier eine Nachricht ein die anstelle von $a->custommessage in die automatisch generierte Nachricht eingefügt wird.';
