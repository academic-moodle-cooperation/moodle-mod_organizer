...
$string['configkeeplocationlinkprivate'] = 'Keep location link private';
$string['configkeeplocationlinkprivate_desc'] = 'When enabled, each slot\'s location link remains hidden from students and is shared only with students who book that slot.';
