...
$string['infobox_statistic_maxreached'] = '{$a->maxreached} of {$a->entries} participants have reached the maximum of {$a->max} bookings';
$string['infobox_statistic_maxreached_group'] = '{$a->maxreached} of {$a->entries} groups have reached the maximum of {$a->max} bookings';
$string['infobox_statistic_minreached'] = '{$a->undermin} of {$a->entries} participants have not reached the minimum of {$a->min} bookings';
$string['infobox_statistic_minreached_group'] = '{$a->undermin} of {$a->entries} groups have not reached the minimum of {$a->min} bookings';
