...
$string['message_info_available'] = 'There are {$a->freeslots} places available for {$a->notregistered} outstanding bookings.';
$string['message_info_available_group'] = 'There are {$a->freeslots} places available for {$a->notregistered} outstanding bookings.';
