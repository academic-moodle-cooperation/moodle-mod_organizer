...
$string['btn_sendall'] = 'Send reminders to all students without enough appointments';
...
$string['infobox_deadline_passed_slotphp'] = '{$a->slots} slots could not be created because registration deadline has passed.';
...
$string['infobox_myslot_userslots_max_reached'] = 'You have booked the maximum amount of {$a->max} bookings.';
$string['infobox_myslot_userslots_max_reached_group'] = 'Your group has booked the maximum amount of {$a->max} bookings.';
$string['infobox_myslot_userslots_min_not_reached'] = 'You have not booked the required amount of {$a->min} bookings yet.';
$string['infobox_myslot_userslots_min_not_reached_group'] = 'Your group has not booked the required amount of {$a->min} bookings yet.';
$string['infobox_myslot_userslots_min_reached'] = 'You have booked the required amount of {$a->min} bookings.';
...
$string['infobox_statistic_maxreached'] = '{$a->maxreached} of {$a->entries} participants booked the maximum of {$a->max} bookings';
$string['infobox_statistic_maxreached_group'] = '{$a->maxreached} of {$a->entries} groups booked the maximum of {$a->max} bookings';
$string['infobox_statistic_minreached'] = '{$a->minreached} of {$a->entries} participants reached the required amount of {$a->min} bookings';
$string['infobox_statistic_minreached_group'] = '{$a->minreached} of {$a->entries} groups reached the required amount of {$a->min} bookings';
