...
$string['visibility_help'] = 'Define here the default option, with which a new slot will be created. 1. "Anonymous": The members of this slot are always invisible to each other. 2. "Visible": All members of this slot are always visible. 3. "Only visible to slot members": Only slot members can see the members of this slot.';
