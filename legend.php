...
function organizer_make_legend($params) {
    ...
    switch ($params['mode']) {
        case ORGANIZER_TAB_APPOINTMENTS_VIEW:
            ...
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('student_slot_past_deadline', get_string('legend_past_deadline', 'organizer')),
                    'width: 33%'
            );
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('organizer_expired', get_string('legend_organizer_expired', 'organizer')),
                    'width: 33%'
            );
            $output .= html_writer::end_tag('tr');
            $output .= html_writer::end_tag('table');
            $output = organizer_legend_tableheader($output);
            $output = organizer_legend_regstatusline($output);
            $output = organizer_legend_anonline($output);
        break;
        case ORGANIZER_TAB_STUDENT_VIEW:
            ...
            $output .= html_writer::start_tag('tr');
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('student_slot_available', get_string('reg_status_slot_available', 'organizer')),
                    'width: 20%'
            );
            $output .= organizer_make_cell(
            ...
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('student_slot_past_deadline',
                    get_string('reg_status_slot_past_deadline', 'organizer')), 'width: 20%'
            );
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('student_slot_expired', get_string('reg_status_slot_expired', 'organizer')),
                    'width: 20%'
            );
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('organizer_expired', get_string('reg_status_organizer_expired', 'organizer')),
                    'width: 20%'
            );
            $output .= html_writer::end_tag('tr');
            $output = organizer_legend_anonline($output);
        ...
        case ORGANIZER_TAB_REGISTRATION_STATUS_VIEW:
            ...
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('status_attended_reapp', get_string('reg_status_slot_attended_reapp', 'organizer')),
                    'width: 25%'
            );
            $output .= organizer_make_cell(
            ...
            $output .= html_writer::start_tag('tr');
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('status_not_registered', get_string('reg_status_not_registered', 'organizer')),
                    'width: 25%'
            );
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('status_not_attended', get_string('reg_status_slot_not_attended', 'organizer')),
                    'width: 25%'
            );
            $output .= organizer_make_cell(
            organizer_get_icon_plus_string('status_not_attended_reapp',
...
/**
 * @param $output of the legend table
 * @return string $output of the legend table with the regstatus line added
 * @throws coding_exception
 */
function organizer_legend_regstatusline($output) {
    ...
    $output .= organizer_make_cell(
        organizer_get_icon_plus_string('no_reg', get_string('reg_status_slot_not_attended_reapp', 'organizer')),
        'width: 20%'
    );
    $output .= organizer_make_cell(
...
/**
 * @param $output of the legend
 * @return string $output with the table header line added
 * @throws coding_exception
 */
function organizer_legend_tableheader($output) {
